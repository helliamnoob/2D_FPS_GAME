...
static void _setKeyboard(uint32& keys, bool down, int key)
{
	...
	{
		switch (key) {
		case 'a': case 'A':		keys |= keyboard_a; break;
		case 37:				keys |= keyboard_left; break;
		case 'd': case 'D':		keys |= keyboard_d; break;
		case 39:				keys |= keyboard_right; break;
		case 'w': case 'W':		keys |= keyboard_w; break;
		case 38:				keys |= keyboard_up; break;
		case 's': case 'S':		keys |= keyboard_s; break;
		case 40:				keys |= keyboard_down; break;
